...
public class tempreture_milk_fragment extends Fragment {
  ...
  private  void  drawTpCircle(View view){
      ...
      LinearLayout linearLayout1 = (LinearLayout)layout1.findViewById(R.id.circle);   
      LinearLayout linearLayout2 = (LinearLayout)layout2.findViewById(R.id.circle);   
      LinearLayout linearLayout3 = (LinearLayout)layout3.findViewById(R.id.circle);   
